...
const WideGameWindow: React.FC<WideGameWindowProps> = ({
    game,
    isLoading,
    isGameFinished,
    children,
            ...
            {!skipDefaultBackground &&
                (game.animatedBackground && game.animatedBackground !== "" ? (
                    ...
                    <Image
                        ...
                        alt="Game Background"
                        fill
                        className="object-cover rounded-[8px] opacity-75"
                        priority
                    />
                ))}
